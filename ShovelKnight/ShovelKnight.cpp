// ShovelKnight.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
...
INT_PTR CALLBACK    ChangeTileSize(HWND, UINT, WPARAM, LPARAM);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_SHOVELKNIGHT, szWindowClass, MAX_LOADSTRING);
	...
	while (true)
	{
		...
		{
			if (CCore::GetInst()->progress() == INT_MAX)
				break;
		}
	}
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_CHANGE_SIZE:
                DialogBox(hInst, MAKEINTRESOURCE(IDD_TILE_SIZE), hWnd, ChangeTileSize);
                break;
			case ID_SAVE:
			{
